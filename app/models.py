...
class Process(models.Model):
    ...
    estado = models.ForeignKey(ProcessStatus, on_delete=models.PROTECT, related_name="processes")
...
class Equipment(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="equipment")
    process = models.ForeignKey(Process, on_delete=models.SET_NULL, null=True, blank=True, related_name="equipment")
...
class Report(models.Model):
    ...
    process = models.ForeignKey(Process, on_delete=models.CASCADE, related_name="reports", null=True, blank=True)
